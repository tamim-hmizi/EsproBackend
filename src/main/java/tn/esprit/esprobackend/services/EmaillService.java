...
public class EmaillService {
    ...
    public EmaillService(JavaMailSender mailSender, TemplateEngine templateEngine) {
  ...
  //  @Scheduled(cron = "*/10 * * * * *") // December 31 at midnight
    public void sendEndOfYearEmail() {
        ...
        try {
            sendTemplatedEmail((String) chercheur.get("email"), (String) chercheur.get("name"), "arbia.sassi@esprit.tn"); // Send the email with dynamic content

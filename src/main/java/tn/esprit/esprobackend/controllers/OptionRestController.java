...
//    }
    @GetMapping("/retrieve-classroom-years/{option-id}")
    public String[] retrieveClassroomYears(@PathVariable("option-id") Long optionId) {
        return optionService.retrieveStartYearAndEndYearForClassroomsByLevelId(optionId);
    }
}

...
//    }
    //expose  retrieveStartYearAndEndYearForClassroomsByLevelId
    //http://localhost:8089/tpfoyer/level/retrieve-classroom-years/8
    @GetMapping("/retrieve-classroom-years/{level-id}")
    public String[] retrieveClassroomYears(@PathVariable("level-id") Long levelId) {
        return levelService.retrieveStartYearAndEndYearForClassroomsByLevelId(levelId);
    }
